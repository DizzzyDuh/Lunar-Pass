        ...
        <>
            ...
            <section id="payment-method">
                <div className="container">
                    ...
                    <br />
                    <input type="radio" id="method" name="payment-method" onChange={(e) => setPaymentMethod(e.target.value)} value="Netbanking" />
                    <label htmlFor="method">Netbanking/Gpay/Card</label>
